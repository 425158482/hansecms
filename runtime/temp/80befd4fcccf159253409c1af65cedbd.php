<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/Users/zhanghan/www/hansecms/application/admini/view/index/editadmin.html";i:1570684760;s:69:"/Users/zhanghan/www/hansecms/application/admini/view/public/head.html";i:1575261364;s:69:"/Users/zhanghan/www/hansecms/application/admini/view/public/menu.html";i:1584714334;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form menu_form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username"  disabled="disabled" value="<?php echo $admini['username']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入登录名" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="pic" lay-verify="required" id="site_logo" autocomplete="off" value="<?php echo $admini['pic']; ?>" placeholder="头像地址" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-upload-list" style="margin: 0">
                        <img class="layui-upload-img" src="<?php echo $admini['pic']; ?>" height="50" id="logo1">
                        <p id="demoText"></p>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" value="<?php echo $admini['name']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux"></div>
            </div>
            <div class="layui-form-item">
